...
`@sanefyi/sane-editor-react` comes with a fully styled UI that makes it an instant, polished editor ready to use in your app.

If you prefer to create your own UI components (menus), or don't want to use React, you can use `@sanefyi/sane-editor-core` (_advanced_, [see docs](https://www.blocknotejs.org/docs/vanilla-js)).
